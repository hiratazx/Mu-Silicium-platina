...
class CommonPlatform ():
    PackagesSupported = ("platinaPkg")
    ArchSupported = ("AARCH64")
    TargetsSupported = ("DEBUG", "RELEASE")
    Scopes = ('platina', 'gcc_aarch64_linux', 'edk2-build')
...
class PlatformBuilder (UefiBuilder, BuildSettingsManager):
    ...
    def SetPlatformEnv (self):
        ...
        self.env.SetValue ("PRODUCT_NAME", "platina", "Platform Hardcoded")
        self.env.SetValue ("ACTIVE_PLATFORM", "platinaPkg/platina.dsc", "Platform Hardcoded")
